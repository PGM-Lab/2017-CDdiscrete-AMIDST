...
plotSeries(1:slots,meanNswDemandUP$x,xaxt = "n", xlab='Time', ylab='NSW demand',type="b", main="UP")
...
plotSeries(1:slots,meanNswDemandDOWN$x,xaxt = "n", xlab='Time', ylab='NSW demand',type="b", main="DOWN")
axis(1, at=1:slots, labels=FALSE)
text(seq(1,slots,2), par("usr")[3] - 40.2, labels = lablist, srt = 90, pos = 2, offset = -0.1, xpd = TRUE)
dev.off()
...
plotSeries(1:slots,meanNswPriceUP$x,xaxt = "n", xlab='Time', ylab='NSW Price',type="b", main="UP")
axis(1, at=1:slots, labels=FALSE)
text(seq(1,slots,2), par("usr")[3] - 40.2, labels = lablist, srt = 90, pos = 2, offset = -0.1, xpd = TRUE)
dev.off()
...
plotSeries(1:slots,meanNswPriceDOWN$x,xaxt = "n", xlab='Time', ylab='NSW Price',type="b", main="DOWN")
axis(1, at=1:slots, labels=FALSE)
text(seq(1,slots,2), par("usr")[3] - 40.2, labels = lablist, srt = 90, pos = 2, offset = -0.1, xpd = TRUE)
dev.off()