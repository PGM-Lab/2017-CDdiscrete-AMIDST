...
plotSeries(df$NB.FS,xaxt="n",xlab='',type='l',main='',col='black', ylab="AUCROC",ylim=c(0.65,1))
...
plotSeries(df$NB.FS,xaxt="n",xlab='',type='l',main='',col='white', ylab="AUC",ylim=c(0.65,1))
